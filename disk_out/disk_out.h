...
namespace disk_out {
    ...
    void fix_vect_vals(std::vector<Values>& input, std::vector<int>& vec_vals);
    void fix_vect_vals(std::vector<Values>& input, std::vector<float>& vec_vals);
    void fix_vect_vals(std::vector<Values>& input, std::vector<uint8_t>& vec_vals);
    void fix_vect_vals(std::vector<Values>& input, std::vector<std::string>& vec_vals, std::vector<uint32_t>& vec_sizes);
    ...
    void escribir_particion_string(auto& inicio, auto& fin, std::string ruta_escritura);
